...
Узнать свой тариф
*101# 
Проверить дополнительный счет
*101*10# 
Проверить количество бонусов
*777*1# 
Подключить Год без абонплат
*365# 
Проверить остаток услуг (минут, интернета)
*101*4# 
ИНТЕРНЕТ
Подключить  Раздача интернета в день 
  *811*24#   
Подключить  Раздача интернета в месяц 
  *811*8#
Отключить интернет в роуминге
 *600*12#
РАЗВЛЕКАТЕЛЬНЫЕ СЕРВИСЫ
Отключить Video PASS
(подписка на 30 дней)	*313*3# 
Отключить подписку на YouTube Premium	зайдите в ваш профиль YouTube, раздел «Платные подписки», нажмите «Отключить подписку»
Отключить Клик	SMS на номер 20255  с текстом OFF (бесплатно)
Отключить SIM-Menu
(погода, гороскоп, новости)	SMS на номер 10251  с текстом СТОП (бесплатно)
Отключить Vodafone Cloud	Зайдите в приложение Vodafone Cloud, раздел "Настройки", нажмите "Отключить услугу"
Отключить ЗнайГде	SMS на номер 7005  с текстом OFF (бесплатно)
Контент-ревизор
(узнать, какие подписки активны по номеру)
SMS с любым текстом на номер 2828  (бесплатно)
 некоторые архивные услуги не отображаются при запросе на номер 2828.Вы можете узнать, что предлагает короткий номер,  на странице
СЕРВИСЫ ПО НОМЕРУ
Проверить и изменить язык SMS-информирования
*722# 
Переадресация всех звонков	подключить **21*+38ХХХXXXXХХХ#
отключить ##002#
статус *#21#
Отключить отчет о доставке SMS	зайдите в ваш телефон, раздел «Настройки сообщения»»
Перезвони мне	*104*+38ХХХXXXXХХХ#
(7 запросов в день)
Остались вопросы по сервисным услугам? Узнайте больше на странице

Вопрос не решен? Позвоните нам:
111  — бесплатно с мобильного Vodafone Украина в Украине;
0800 400 111  — консультация по тарифам и услугам Vodafone Украины для абонентов других операторов Украины (бесплатно с любого номера в Украине).
